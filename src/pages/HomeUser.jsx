    ...
    <div className='bg-gray-200 min-h-screen '>
      {/* TabBar resposiva*/}
        ...
        <div className='ca:w-[50%] px-6 flex justify-evenly mt-6'>
          <Button onClick={handleMissing} variant='gradient' size='sm' loading={loadingButton} color={`${MissingState? 'orange' : 'gray'}`}>Missing Data</Button>
          <Button onClick={handleFound} variant='gradient' size='sm' loading={loadingButton2} color={`${FoundState? 'orange' : 'gray'}`}>Found Data</Button>
        </div>
